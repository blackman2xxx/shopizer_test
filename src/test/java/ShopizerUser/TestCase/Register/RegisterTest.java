...
public class RegisterTest extends Init {
    ...
    public void RegisterTest() throws Exception {
        ...
        registerPage.Register(excel.getCellData(2,2), excel.getCellData(1,3 ));
        registerPage.Register(excel.getCellData(3,2), excel.getCellData(1,3 ));
        registerPage.Register(excel.getCellData(4,2), excel.getCellData(1,3 ));
        registerPage.Register(excel.getCellData(5,2), excel.getCellData(1,3 ));
